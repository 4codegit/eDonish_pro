...
// NewEdonishClient - создаёт новый клиент
...
func (c *EdonishClient) Login(ctx context.Context, username, password string) (*LoginResponse, error) {
	...
	if err := json.Unmarshal(body, &loginResp); err != nil {
		return nil, fmt.Errorf("ошибка парсинга JSON ответа: %w, тело: %s", err, string(body))
	}
...
// GetSchedule получает расписание
